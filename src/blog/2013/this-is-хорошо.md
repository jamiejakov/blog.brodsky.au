...
description: >-
  This is Хорошо это программа которая обозревает вирусние видео на YouTube. Я
  на TiX наткнулся когда выходил еще 20й выпуск (сейчас уже вышел 203й), и мне
  сразу понравилось то что кто-то в рунете занимается этим (в английском
  интернете этим занимается Ray William Johnson со своей программой _\=3_).
  Ребята молодцы! Продолжайте в том-же духе, и пусть у вас будет все больше и
  больше подписчиков.
pubDate: 2013-03-17T00:00:00.000Z
published: true
tags: ['internetz', 'this-is-хорошо']
---
